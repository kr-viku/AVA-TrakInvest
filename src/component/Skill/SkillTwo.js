                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6">
                            <div className="skill_content_two">
                                ...
                                <div className="row">
                                    <CounterItem col="col-md-6 s_item" CText='1000' CLogo="+" pdescription='Pre Screened VA’s'/>
                                    <CounterItem col="col-md-6 s_item" CText='50000' CLogo="+" pdescription='Hours saved'/>
